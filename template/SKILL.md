...
Replace this body with skill instructions. Recommended sections:

- Step-by-step instructions
- Examples of inputs and outputs
- Common edge cases

Keep this file under 500 lines. Move long reference material to
`references/` and helper code to `scripts/`.
