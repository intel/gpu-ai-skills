...
These skills are:
 - cuda-to-xpu-migration -> "plugins/intel-model-skillpack/skills/cuda-to-xpu-migration/SKILL.md"
 - llamacpp-xpu-run -> "plugins/intel-model-skillpack/skills/llamacpp-xpu-run/SKILL.md"
 - model-can-it-fit -> "plugins/intel-model-skillpack/skills/model-can-it-fit/SKILL.md"
 - model-config-recommend -> "plugins/intel-model-skillpack/skills/model-config-recommend/SKILL.md"
 - sglang-xpu-bench -> "plugins/intel-model-skillpack/skills/sglang-xpu-bench/SKILL.md"
 - sglang-xpu-run -> "plugins/intel-model-skillpack/skills/sglang-xpu-run/SKILL.md"
 - torch-xpu-bench -> "plugins/intel-model-skillpack/skills/torch-xpu-bench/SKILL.md"
 - torch-xpu-profile -> "plugins/intel-model-skillpack/skills/torch-xpu-profile/SKILL.md"
 - torch-xpu-run -> "plugins/intel-model-skillpack/skills/torch-xpu-run/SKILL.md"
 - vllm-xpu-bench -> "plugins/intel-model-skillpack/skills/vllm-xpu-bench/SKILL.md"
 - vllm-xpu-profile -> "plugins/intel-model-skillpack/skills/vllm-xpu-profile/SKILL.md"
 - vllm-xpu-run -> "plugins/intel-model-skillpack/skills/vllm-xpu-run/SKILL.md"
 - xpu-container-run -> "plugins/intel-model-skillpack/skills/xpu-container-run/SKILL.md"
 - xpu-deploy-plan -> "plugins/intel-model-skillpack/skills/xpu-deploy-plan/SKILL.md"
 - xpu-discover -> "plugins/intel-model-skillpack/skills/xpu-discover/SKILL.md"
 - xpu-model-type-detect -> "plugins/intel-model-skillpack/skills/xpu-model-type-detect/SKILL.md"
 - xpu-port -> "plugins/intel-model-skillpack/skills/xpu-port/SKILL.md"
 - xpu-profile-unitrace -> "plugins/intel-model-skillpack/skills/xpu-profile-unitrace/SKILL.md"
 - xpu-runtime-preflight -> "plugins/intel-model-skillpack/skills/xpu-runtime-preflight/SKILL.md"
 - xpu-system-setup -> "plugins/intel-model-skillpack/skills/xpu-system-setup/SKILL.md"
